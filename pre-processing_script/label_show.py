...
def plot_one_box_landmarks(x, y, img, color=None, label=None, landmarks=[], line_thickness=3):
    ...
    for i in range(5):
        ...
        if i == 2:
            cv2.circle(img, point_final, tl, (0, 0, 255), -1)
        else:
...
def xywh2xyxy(img, xywh):
    ...
    x[4] = xywh[1] * w + 0.5 * xywh[3] * w
    y[4] = xywh[2] * h + 0.5 * xywh[4] * h
    landmarks = xywh[5:]
    # names = ['B1', 'B2', 'B3', 'B4', 'B5', 'BO', 'BS', 'R1', 'R2', 'R3', 'R4', 'R5', 'RO', 'RS'] #装甲板
    names = ['RR', 'RW', 'BR', 'RW']  # 能量机关
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path', type=str,
                        default='', help='image dir')
    parser.add_argument('--txt_path', type=str,
                        default='', help='txt dir')
