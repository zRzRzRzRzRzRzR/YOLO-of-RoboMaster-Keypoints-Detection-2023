...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/armor/yolov8-0.5-SimAM-armor.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default='../armor_detect/train', help='save to project/name')
