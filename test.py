...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='../win-kpt/runs/train/exp2/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/winmill/win_kpt.yaml', help='*.data path')
    ...
    parser.add_argument('--project', default='../armor_backup/runs/test', help='save to project/name')
